...
```{exercise} Ev3  Auf und ab ⭐
:label: exercise-ev3-up-and-down

Bau einen Arm für den Roboter

```

```{exercise} Ev3 Würfel fangen ⭐⭐
:label: exercise-ev3-die-catcher
...
```{exercise} Ev3 Würfel schieben ⭐⭐
:label: exercise-ev3-push-the-box
...
```{exercise} Ev3 Um die Ecke schieben ⭐⭐⭐
:label: exercise-ev3-around-the-corner
